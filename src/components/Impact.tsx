        ...
        <div className="flex flex-col lg:flex-row gap-12 items-center">
          ...
          <div className="w-full lg:w-1/2">
            ...
            <h3 className="text-4xl font-serif font-bold text-stone-900 mb-6">
              Monitoring <span className="text-[#c4703d]">1,200km</span> of
              Coastline
            </h3>
            <p className="text-lg text-stone-600 mb-10">
              Our platform provides real-time data that helps government
              agencies and NGOs make informed decisions about conservation
              efforts.
            </p>
              ...
              <div
                ...
                className="bg-white p-6 rounded-xl border border-stone-100 shadow-sm">
                  ...
                  <div className="text-3xl md:text-4xl font-bold text-[#1a4d2e] mb-1 font-serif">
                    {stat.value}
                    <span className="text-[#c4703d] text-2xl">
                      {stat.suffix}
                    </span>
                  </div>
