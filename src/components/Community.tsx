    ...
    <section id="community" className="py-20 bg-white">
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-[#c4703d] font-bold text-sm tracking-widest uppercase mb-4">
            Community First
          </h2>
          ...
          <p className="text-stone-600 text-lg">
            Technology is only a tool. The real work is done by the people who
            live and work in these ecosystems every day.
          </p>
        </div>

        <div className="grid md:grid-cols-3 gap-8 mb-16">
          {[
          'https://images.unsplash.com/photo-1531384441138-2736e62e0919?q=80&w=2787&auto=format&fit=crop',
          'https://images.unsplash.com/photo-1489749798305-4fea3ae63d43?q=80&w=2874&auto=format&fit=crop',
          'https://images.unsplash.com/photo-1516026672322-bc52d61a55d5?q=80&w=2872&auto=format&fit=crop'].
          map((src, index) =>
          <motion.div
            key={index}
            initial={{
        ...
        <div className="bg-[#f5f2eb] rounded-3xl p-8 md:p-12 relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-4xl mx-auto text-center">
            <p className="text-2xl md:text-3xl font-serif text-stone-800 leading-relaxed mb-8">
              "Before we had this data, we were fighting blindly. Now we know
              exactly where the threats are, and we can mobilize our community
              to protect the areas that need it most."
            </p>
