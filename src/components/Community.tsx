        ...
        <section id="community" className="py-20 bg-white">
            <div className="container mx-auto px-4 md:px-6">
                ...
                <div className="grid md:grid-cols-3 gap-8 mb-16">
                    {[
                        "https://gedae.ggpen.gov.ao/ferramenta-de-visualizacao/otchiva/images/DJI_20251101172812_0839_D.jpg",
                        "https://gedae.ggpen.gov.ao/ferramenta-de-visualizacao/otchiva/images/DJI_0474.jpg",
                        "https://gedae.ggpen.gov.ao/ferramenta-de-visualizacao/otchiva/images/DJI_20251101172819_0840_D.jpg",
                    ].map((src, index) => (
                        <motion.div
                            key={index}
                            initial={{
