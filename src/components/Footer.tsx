    ...
    <footer className="bg-[#1a1a1a] text-white pt-20 pb-10">
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid md:grid-cols-4 gap-12 mb-16">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-stone-400 max-w-md mb-8 leading-relaxed">
              A national initiative combining satellite technology and community
              action to preserve Angola's vital coastal ecosystems for future
              generations.
            </p>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-stone-500 text-sm">
          <p>&copy; 2024 Angola Mangrove Monitor. All rights reserved.</p>
