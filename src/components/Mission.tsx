        ...
        <div className="grid md:grid-cols-2 gap-12 md:gap-20 items-center">
          ...
          <motion.div
            ...
            <div className="aspect-[4/5] rounded-2xl overflow-hidden shadow-2xl">
              <img
                src="https://images.unsplash.com/photo-1596326224823-37f24e63e639?q=80&w=2832&auto=format&fit=crop"
            ...
            <div className="absolute -bottom-10 -right-10 w-2/3 aspect-square rounded-2xl overflow-hidden shadow-xl border-8 border-stone-50 hidden md:block">
              <img
                src="https://images.unsplash.com/photo-1518182170546-0766bd6f6a56?q=80&w=2000&auto=format&fit=crop"
          ...
          <motion.div
            ...
            <h2 className="text-[#1a4d2e] font-bold text-sm tracking-widest uppercase mb-4">
              Our Mission
            </h2>
            <h3 className="text-4xl md:text-5xl font-serif font-bold text-stone-900 mb-6 leading-tight">
              Preserving the <span className="text-[#1a4d2e]">Green Lungs</span>{' '}
              of our Coastline
            </h3>
            <p className="text-lg text-stone-600 mb-8 leading-relaxed">
              Mangroves are more than just trees; they are the guardians of
              Angola's coastline. They protect communities from storms, serve as
              nurseries for fish, and sequester carbon at rates far higher than
              terrestrial forests.
            </p>
            ...
            <div className="p-6 bg-white rounded-xl border border-stone-100 shadow-sm">
              <p className="text-stone-800 italic font-serif text-lg">
                "Our technology serves the people. We use satellites not just to
                watch, but to empower local communities to protect their
                heritage."
              </p>
            </div>
          </motion.div>
