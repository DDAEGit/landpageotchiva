  ...
  return (
    <section className="relative h-screen min-h-[800px] flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <img
          src="https://images.unsplash.com/photo-1572455044327-7348c1be7267?q=80&w=2803&auto=format&fit=crop"
        ...
        <div className="max-w-3xl">
          <motion.div
            ...
            <p className="text-lg md:text-xl text-stone-200 mb-8 max-w-2xl leading-relaxed">
              Combining advanced earth observation with community wisdom to
              monitor, protect, and restore our vital coastal ecosystems.
            </p>
      ...
      <div className="absolute bottom-0 left-0 right-0 border-t border-white/10 bg-black/20 backdrop-blur-sm">
        <div className="container mx-auto px-4 py-6 flex flex-wrap justify-between items-center gap-8 text-white/90">
          <div className="flex items-center gap-3">
            <div className="text-3xl font-serif font-bold text-[#c4703d]">
              12
            </div>
